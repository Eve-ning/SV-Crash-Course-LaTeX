\subsubsection{Uneven Visual Spacing Scenario 1}
\begin{tikzpicture}
...
\draw [<-] (4.0,1) -- (4.5,1) node [anchor=west, xshift=0.5] {\textcolor{darkgreen}{0.5x}};
\draw [<-] (4.0,2) -- (4.5,2) node [anchor=west, xshift=0.5] {\textcolor{darkgreen}{1.0x}};

\end{tikzpicture}
\begin{tikzpicture}

\foreach \x in {0,1,2,3,4}
    \draw (\x cm,0.0) -- (\x cm, 6);
    
\draw [line width=10] (0,1.175) -- (1,1.175);
\draw [line width=10] (1,3.175) -- (2,3.175);
\draw [line width=10] (2,4.175) -- (3,4.175);
\draw [line width=10] (3,5.175) -- (4,5.175);
